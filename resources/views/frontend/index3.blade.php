...
.header_h1{
    ...
    line-height: 65px;
    padding-top: 100px;
    filter: drop-shadow(8px 8px 4px #00000046);
}
.header_h1 span{
    font-size:70px;
}
...
@media (max-width:400px){
    .ui.popup{display: none !important;}
    .header_h1{
        text-transform:uppercase;
        font-size:80px;
        color:#fff;
...
<div class="w-100 d-flex align-items-center" style="min-height: 60vh;background: #5928e5;">
    <div class="col-12 text-center">
        <h1 class="header_h1">
            Lead<br><span>Generation</span></h1>
    </div>
</div>
...
<section class="container" style="padding:20px 0 50px 0;">
    <div class="row">

        <div class="col-md-12 search_div" id="country_Name_Box">
            <input type="hidden" id="country_Name_catch">
            {{-- <label for="" class="w-100" style="text-transform:uppercase;">Country Name </label> --}}
            {{-- <i class="fa-solid fa-angle-down CONCON1"></i> --}}
...
<section class="container d-none animate__animated" id="DataTableMain">
    <div class="pb-3">
        <div class="row justify-content-between align-items-end pt-4">
            <div class="col-xs-12 col-sm-12 col-md-3">
                <h4 style="font-size:25px;text-transform:uppercase;">Search Specific Leads</h4>
    ...
    <div class="col-md-12 search_div" style="display: flex;align-items: center;justify-content:center;" id="contact_box">
    ...
    <script>
        ...
        $('#contact_box').click(function () {
            // $('#DataTableMain').addClass('d-none');
            $('#contact_main').removeClass('d-none');
            $('#contact_main').addClass('animate__fadeInUp');
        })
    ...
    <script>
        ...
        if (country_name != null) {
            $('#country_box').val(country_name)
        } else {
            $('#country_box_grp').addClass('d-none')
        };
        if (cities_name != null) {
            $('#city_box').val(cities_name)
        } else {
            $('#city_box_grp').addClass('d-none')
        };
